            ...
            <section class="h-100 h-custom" style={{ backgroundColor: "#eee" }}>
                <div class="container h-100 py-5">
                    <div class="row d-flex justify-content-center align-items-center h-100">
                        <div class="col">
                            <div class="card shopping-cart" style={{ borderRadius: 15 }}>
                                <div class="card-body text-black">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 px-5 py-4">
                                            ...
                                            <div class="d-flex align-items-center mb-5">
                                                <div class="flex-shrink-0">
                                                    <img src="https://mdbcdn.b-cdn.net/img/Photos/Horizontal/E-commerce/Products/1.webp"
                                                        class="img-fluid" style={{ width: 150 }} alt="Generic placeholder image" />
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="def-number-input number-input d-flex">
                                            ...
                                            <hr class="mb-4" style={{ height: 2, backgroundColor: "#1266f1", opacity: 1 }} />
